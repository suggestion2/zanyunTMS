...
<section>
    <div id="errorBody">
        <img src="/images/wechat/500.png;">
        <p class="err-tip" style="font-size: 18px; margin-top: 50px;">哎呀，服务器错误，请稍后访问！ </p>
        <p style="font-size: 12px; margin-top: 20px;">已经把这个错误信息反馈给管理员，您可以选择：</p>
        <a class="backToIndex weui-btn weui-btn_primary" href="/">返回首页</a>
    </div>
</section>
<script>
    function is_weixin() {
        ...
        if (ua.match(/MicroMessenger/i) != 'micromessenger') {
            $('#errorBody img').attr('src','/images/web/500.png');
