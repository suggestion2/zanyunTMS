...
<div id="large-header" class="large-header">
    ...
    <div class="login_box" style="height: 420px">
        <ul id="myTab" class="nav nav-tabs">
            <li class="col-xs-12 active"><a href="#register" data-toggle="tab" style="color: #333">货主注册</a>
        </ul>
            ...
            <div class="tab-pane fade in active" id="register">
                <form class="form-horizontal" role="form" id="register_form">
                    ...
                    <div class="item_band form-group" style="margin-bottom: 0">
                        <a href="javascript:;" class="btn btn-danger resLogBtn" onclick="location.href='/login'">已有货主账号，立即登录</a>
                    </div>
