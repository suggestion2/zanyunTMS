        ...
        <div class="panel-body">
            <div class="center_tab">
                <ul class="nav nav-tabs">
                    <li <#if status==10>class="active"</#if>><a onclick="openList(10)">全部订单</a></li>
                    <li <#if status==0>class="active"</#if>><a onclick="openList(0)">待接单</a></li>
                            ...
                            <#if list??>
                                <#if count!=0>
                                    ...
                                    <tr>
                                        ...
                                        <td width="200px">${(item.ownerFreight!'0')+'元'}</td>
                                        <td width="200px">
        ...
        if(totalPages==0){
            ...
            var options = {
                ...
                onPageClicked: function (event, originalEvent, type, page) { //异步换页
                    tools.ajaxPost('/api/order/owner/list',{"status":status,"pageIndex":page-1,"pageSize":"10"},function (json) {
                        var str='';
