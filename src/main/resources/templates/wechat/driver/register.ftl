...
<section class="content">
    ...
    <div class="content_body resLog_box">
        <h4>第一步 创建账号</h4>
        <p class="reg_tip">使用您的手机号码创建账号并开启司机账户。</p>
        <form id="register_form" class="reg_form">
            <div class="item">
                <input name="phone" type="number" placeholder="请输入手机号码">
                <a class="sendVerCode">验证手机号码</a>
            </div>
            <div class="item">
                <input name="captcha" type="number" placeholder="请输入短信验证码">
            </div>
            <div class="item">
            ...
            <div class="item_band">
                <a href="javascript:;" class="weui-btn weui-btn_primary" onclick="goToLogin()">已有司机账号，立即登录</a>
            </div>
        </form>
    </div>
</section>
