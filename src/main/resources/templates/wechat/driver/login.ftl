...
<section class="content">
    ...
    <div class="content_body resLog_box">
        <#--<h4>登录司机账号</h4>-->
        <p class="reg_tip">输入已注册的司机账号和密码完成登录。货主使用订车服务须从公众号专门菜单进入。</p>
        <form id="login-form" class="reg_form">
            ...
            <div class="item_submit">
                <button class="weui-btn weui-btn_primary createAccount" type="button" onclick="login()">登录</button>
            </div>
            <div class="item text-right">
                <a href="javascript:;" onclick="forgetPassword()">忘记密码</a>
            </div>
            <div class="item">
                <a href="javascript:;" class="weui-btn weui-btn_primary" onclick="register()">没有司机账号，立即注册</a>
            </div>
        </form>
    </div>
</section>
<script>
    ...
    function forgetPassword() {
        tools.navigate("/driver/resetPassword");
    }
    function register() {
